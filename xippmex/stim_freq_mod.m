% This example will modulate the frequency of a delivered stimulation pulse
...
% the stimulation pulses will be delivered at a constant biphasic amplitude
% with the frequency of the stimulation pulses is modulated based on the 
% level of the input.
%
...
while true
    ...
    % if the force threshold has been crossed, modulate the frequency of
