...
filename = 'calib_online/Wa180216_s228a_dirmem_bci_discrete_0001modelparamstestgauss50msalltrialonlinetest.mat';
timebin = 0.0005;
numevents = 10;
loopsperbin = 8;
...
keepneurons = [keepneurons;zeros(96,1)];
...
postind = 1;
testfile = ['bci_log/',tempname,'_',num2str(postind),'.txt'];
...
%                 end
               ...
               mintime = min(matspiketimes(matspiketimes>0))/30000;
               maxtime = max(matspiketimes)/30000;
                if mintime == 0
                    break
                end
...
%             end
            ...
            % sendposteriors
            if size(countbuffer,2)>=loopsperbin
            ...
            if offlinemodeflag==0
                ...
                if demoflag == 1
                    ...
                    matlabUDP2('send',sockind,num2str(posterior,3));
                end
                testcursor = testcursor + 1;
            end
