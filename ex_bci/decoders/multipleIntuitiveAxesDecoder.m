...
% Start of trial, use the initial seeded values here
...
currLDAProjection = currLDAParams.projVec' * newFaProjs;

% Smooth LDA projection 
currSmoothedLDAProjs = (1-alpha) .* currSmoothedLDAProjs + alpha*(currLDAProjection); % 1 x 1?
