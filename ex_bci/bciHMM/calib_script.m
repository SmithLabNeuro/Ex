function modelparams = calib_script(filename,filepath,nTrainTrials,nDelayBins,zDim,verbose,sortFlag,gamma)
    ...
    %% calibrate hmm decoder (LDA+HMM)
    [~,trainingdat] = prepCalibCounts(trainingdat,targOffCode,fixOffCode,minchannelnum,bin);
...
%     saveName = sprintf('X:pepelepew/%s_lowdHmm.mat',filename(1:8));
