%% Quick script to test control computer communication with NIP via xippmex

% make sure xippmex is in your path. if not, try this:
%addpath('/home/smithlab/Dropbox/smithlabrig/Ex/xippmex');
...
if ~isempty(stimChans)
    disp(['Found these stim channels ',num2str(stimChans)]);
else
    disp('Found no valid stim chans');
end
...
% opers = xippmex('opers')
% 
% xippmex('signal',257:288,'stim',257:288)
